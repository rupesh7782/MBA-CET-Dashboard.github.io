...
const oldModalContent = `          <div className="grid grid-cols-2 gap-3">
            <div>
...
const newModalContent = `          <div className={fileUrl?.startsWith('data:application/pdf') ? "block" : "grid grid-cols-2 gap-3"}>
            <div>
              <label className="block text-[#A9A9A9] mb-1 font-medium">Category</label>
              <select
                value={category}
...
console.log('updated modal form');
