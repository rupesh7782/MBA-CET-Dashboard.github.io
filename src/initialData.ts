...
export const initialPyqItems: PyqItem[] = [
  {
    id: 'pyq-1',
    title: 'MBA CET 2024 Day 1 Slot 1 Official Solved Paper.pdf',
    category: 'MBA CET',
    year: '2024',
    subject: 'Full Length',
    fileSize: '12.4 MB',
    ...
    weightage: 'Must Solve',
    solvedStatus: 'Solved',
    tags: ['CET 2024', 'Slot 1', 'Solved Paper', '200 Qs'],
    notes: 'Actual 200 Questions paper with detailed answer keys. Moderate VARC, lengthier DI sets and speed-heavy Abstract Reasoning.'
  },
  {
    id: 'pyq-2',
    title: 'MBA CET 2024 Day 2 Slot 2 Memory-Based Question Bank.pdf',
    category: 'MBA CET',
    year: '2024',
    subject: 'Full Length',
    fileSize: '9.8 MB',
    ...
    weightage: 'Must Solve',
    solvedStatus: 'In Progress',
    tags: ['CET 2024', 'Slot 2', 'Puzzles Focus'],
    notes: 'High weightage of Matrix & Parallel Row puzzles in LR. 25 Abstract questions with rotation patterns.'
  },
  {
    id: 'pyq-3',
    title: 'MBA CET 2023 Actual Slot 1 & 2 Question Paper + Solutions.pdf',
    category: 'MBA CET',
    year: '2023',
    subject: 'Full Length',
    fileSize: '15.2 MB',
    ...
    weightage: 'Must Solve',
    solvedStatus: 'Solved',
    tags: ['CET 2023', 'Official Paper', 'Full Solutions'],
    notes: 'Comprehensive solution set. Excellent for benchmarking target scores of 155+ for JBIMS Churchgate cutoffs.'
  },
  {
    id: 'pyq-4',
    title: 'MBA CET 2022 Slot 1-4 Complete Solved Paper Compilation.pdf',
    category: 'MBA CET',
    year: '2022',
    subject: 'Full Length',
    fileSize: '22.1 MB',
    ...
    solvedStatus: 'Not Started',
    tags: ['CET 2022', 'All Slots', 'Compilation'],
    notes: 'Compilation across 4 slots with question type classification and shortcut approaches.'
  },
  {
    id: 'pyq-5',
    title: 'Imp Topic: Linear & Circular Floor Puzzles 100 Solved Master Set.pdf',
    ...
    weightage: 'High Weightage',
    solvedStatus: 'In Progress',
    tags: ['Imp Topic', 'Puzzles', 'High Weightage', 'LR 75 Marks'],
    notes: 'Top 20 recurring arrangement patterns tested in CET. Crucial for locking 60+ in LR section.'
  },
  {
    id: 'pyq-6',
    title: 'Imp Topic: Abstract Reasoning 500 Non-Verbal Visual Analogies & Series.pdf',
    category: 'Important Topics',
    year: 'All-Time',
    subject: 'AR',
    fileSize: '16.7 MB',
    ...
    weightage: 'Must Solve',
    solvedStatus: 'Solved',
    tags: ['Imp Topic', 'Abstract Reasoning', '25/25 Target'],
    notes: 'Speed drill containing all 5 non-verbal types: Clockwise movement, Sector shifts, Inversions, and Dot-in-circle series.'
  },
  {
    id: 'pyq-7',
    title: 'Imp Topic: Quant Speed Math, TSD & Work Arithmetic 200 Questions.pdf',
    category: 'Important Topics',
    year: 'All-Time',
    subject: 'QUANT',
    fileSize: '11.5 MB',
    ...
    weightage: 'High Weightage',
    solvedStatus: 'In Progress',
    tags: ['Imp Topic', 'Arithmetic', 'Speed Math', 'Formulas'],
    notes: 'Arithmetic constitutes 65% of Quant in CET. Covers shortcut ratios, allegation mixtures, and chain rule.'
  },
  {
    id: 'pyq-8',
    title: 'CAT & XAT High-Yield LRDI Sets for 99.99 Percentile Edge.pdf',
    category: 'CAT',
    year: '2023',
    subject: 'LRDI',
    fileSize: '14.0 MB',
    ...
    solvedStatus: 'Not Started',
    tags: ['CAT', 'XAT', 'Advanced LRDI'],
    notes: 'Advanced reasoning sets for building high conceptual depth to tackle unexpected hard questions.'
  }
];
