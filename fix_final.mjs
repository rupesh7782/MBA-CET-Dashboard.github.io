...
const oldStr = `                <div className="mt-5 pt-3 border-t border-white/5 flex items-center justify-between">
...
const newStr = `                <div className="mt-5 pt-3 border-t border-white/5 flex items-center justify-between">
                  <div className="flex items-center space-x-3 text-[11px] text-[#707070]">
